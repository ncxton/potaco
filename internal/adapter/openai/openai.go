...
// Edit is not yet implemented for the OpenAI adapter.
...
// DiscoverModels is not yet implemented for the OpenAI adapter.
func (a *Adapter) DiscoverModels(ctx context.Context) ([]adapter.Model, error) {
	return nil, adapter.ErrDiscoveryFailed
}

// Verify is not yet implemented for the OpenAI adapter.
func (a *Adapter) Verify(ctx context.Context) error {
	return adapter.ErrVerificationFailed
}

// ModelParams is not yet implemented for the OpenAI adapter.
